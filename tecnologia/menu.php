...
<head>
    <meta charset="UTF-8">
    <title>Tecnológia - LuisElectronic</title>
    ...
    <meta name="description" content="Encuentra los mejores articulos e información sobre Tecnólogia de vanguardia">
    <meta name="keywords" content="tecnologia, ingenieria">
    <link rel="canonical" href="https://www.luiselectronic.com/tecnologia/menu">
...
<body>
    <div class="conteiner">
        ...
        <main class="main">
            ...
            <!--/*---------*/-->
            <section id="articles">
                <h1>Artículos de Tecnológia de LuisElectronic</h1>
                ...
                <article class="proyect">
                    <div class="image-wrap">
                        <a href="#"><img src="imagenes-tecnologia/prueba.png" alt="Imagen"></a>
                    </div>
