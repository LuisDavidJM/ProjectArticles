...
<head>
    <meta charset="UTF-8">
    <title>Tecnologias de internet - LuisElectronic</title>
    ...
    <meta name="description" content="Encuentra los mejores articulos e información sobre varios temas de ingenieria">
    <meta name="keywords" content="ingenieria, internet, tecnologia">
    <link rel="canonical" href="https://www.luiselectronic.com/otros/menu">
...
<body>
    <div class="conteiner">
        ...
        <main class="main">
            ...
            <!--/*---------*/-->
            <section id="articles">
                <h1>Otros Artículos de LuisElectronic</h1>
                ...
                <!--
                  <article class="proyect">
                    <div class="image-wrap">
                      <a href="#"><img src="imagenes-otros/prueba.png" alt="Imagen"></a>
                    </div>
